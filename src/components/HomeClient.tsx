...
// const MotionButton = motion.button as React.ComponentType<HTMLMotionProps<"button"> & React.ButtonHTMLAttributes<HTMLButtonElement>>;
...
const Hero = () => (
  <MotionSection
    ...
    style={{
      backgroundImage: "url(https://via.placeholder.com/1920x600?text=GSOC+Journey)", // Replace with actual image later
